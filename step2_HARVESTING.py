...
# with command line options: step2 -s HARVESTING:dqmHarvesting --harvesting AtRunEnd --conditions 91X_upgrade2017_realistic_v5 --era Run2_2017 --geometry DB:Extended --mc --scenario pp --filein file:step1_RAW2DIGI_L1Reco_RECO_EI_DQM.root --filetype DQM -n -1
...
process.source = cms.Source("DQMRootSource",
    fileNames = cms.untracked.vstring('file:step1_RAW2DIGI_L1Reco_RECO_EI_DQM.root')
)
